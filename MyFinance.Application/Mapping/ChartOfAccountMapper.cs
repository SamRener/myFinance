...
public static class ChartOfAccountMapper
{
    ...
    public static ChartOfAccount ToModel(this ChartOfAccountDto dto) => new(dto.Id, dto.Name, (ChartOfAccountsType)Enum.Parse(typeof(ChartOfAccountsType), dto.Type.ToString()));
